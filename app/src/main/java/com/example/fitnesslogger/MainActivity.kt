...
//ran into issues with fragments overlapping my views

//extreme difficulty simply changing the color of the days

//another challenge I ran was not being able to use onActivityResult methods,
//I had to learn about contracts which proved to be tough
//ran into a problem of frquent crashing due to the recyclerView trying to update while I was typing
//had to learn about debouncing to solve htis
//Needed to add a 'textWatcher' to ensure updates are made after the user is done typing to reduce crashes.

//Id consider this project to be unfinished as there isnt a way to save data.
//I looked at several options, such as databases and the mvvm structure, but they seemed to hard
//to learn/ implement on time so I went with what I did in a previous project, which was reading from csvs
//but this ended up causing a plethora of errors, and infanite feedback loops that I wasnt equiped to solve. 

class MainActivity : AppCompatActivity(), CalendarAdapter.OnItemListener, ExerciseFragment1.OnDayColorChangeListener {
